  ...
  return (
    <section className="py-12 md:py-20">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 md:grid-cols-[1.15fr_0.85fr] md:px-6">
        <div>
          <div className="mb-4 text-xs font-semibold uppercase tracking-[0.16em] text-[var(--brand-red)]">
          ...
          <ul className="mt-8 space-y-3">
            {heroBullets.map((item) => (
              <li
                key={item}
                className="text-base leading-7 text-[var(--brand-graphite)]"
              >
                — {item}
              </li>
            ))}
        ...
        <div className="rounded-[32px] border border-black/10 bg-white p-6 md:p-8">
          <div className="text-sm font-semibold uppercase tracking-[0.14em] text-[var(--brand-red)]">
          ...
          <div className="mt-6 grid gap-4">
            <div className="rounded-[28px] bg-[var(--brand-bg)] p-5">
              ...
              <div className="mt-2 text-xl font-bold text-[var(--brand-graphite)]">
                Основной профиль компании и главный акцент сайта
              </div>
            </div>
            ...
            <div className="rounded-[28px] bg-[var(--brand-bg)] p-5">
              ...
              <div className="mt-2 text-xl font-bold text-[var(--brand-graphite)]">
                Быстрый вход в объект и мост в кровельные работы
              </div>
            </div>
            ...
            <div className="rounded-[28px] bg-[var(--brand-bg)] p-5">
              ...
              <div className="mt-2 text-xl font-bold text-[var(--brand-graphite)]">
                Технологичное решение для мягкой кровли без лишнего демонтажа там,
                где это возможно
              </div>
            </div>
          </div>
