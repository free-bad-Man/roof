    ...
    <>
      ...
      <GlassSection>
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {[
            'Профильный подход к кровле, восстановлению и гидроизоляции',
      ...
      <GlassSection>
        <SectionTitle
          ...
          text="Ниже — ориентировочные цены для первичного понимания бюджета. Это не окончательная смета, а стартовые ориентиры до осмотра объекта и уточнения состояния покрытия, узлов и объёма работ."
        />
